...
async function main(){
  ...
  const context={AGCDSKY:api,console,window:null};context.window=context;vm.createContext(context);installFacade(context,api,lifecycle);
  ...
  const loading={AGCDSKY:loadingApi,console,window:null};loading.window=loading;vm.createContext(loading);installFacade(loading,loadingApi,loadingLifecycle,'API DEFERRED');vm.runInContext(source,loading);
