...
function digitPath(logical,ox){
  switch(logical){
    ...
    case 1:return `M${px(ox,.441577898)},${py(.269917)} L${px(ox,.505451)},${py(.031888012)} L${px(ox,.413468898)},${py(.123869)} L${px(ox,.374277898)},${py(.269917)} Z`; // b: right upper
    case 2:return `M${px(ox,.371594898)},${py(.279917)} L${px(ox,.325402898)},${py(.452054)} L${px(ox,.371185049)},${py(.532239310)} L${px(ox,.438893898)},${py(.279917)} Z`; // c: right lower
    ...
    case 4:return `M${px(ox,.121184898)},${py(.532240)} L${px(ox,.188893898)},${py(.279917)} L${px(ox,.121594898)},${py(.279917)} L${px(ox,.053885898)},${py(.532240)} Z`; // e: left lower
    case 5:return `M${px(ox,.124277898)},${py(.269917)} L${px(ox,.191577898)},${py(.269917)} L${px(ox,.2335968980)},${py(.113331)} L${px(ox,.187590898)},${py(.033978)} Z`; // f: left upper
