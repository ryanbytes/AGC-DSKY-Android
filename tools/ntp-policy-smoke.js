...
console.log('  native-only SNTP, no clock-setting privilege, outlier rejection, recovery scheduling, shell NTP authority, API bridge, and corrected DSKY clock source verified');
