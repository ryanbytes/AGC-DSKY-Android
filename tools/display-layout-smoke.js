...
assert(STYLE.includes('.el-comp-bg{fill:var(--el);opacity:0}') &&
       STYLE.includes('.comp-el.on .el-comp-bg{opacity:.92}'),
  'only the COMP ACTY EL background may disappear while off');
