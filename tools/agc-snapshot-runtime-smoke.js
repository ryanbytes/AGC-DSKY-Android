...
const timers=[];
const context={console,JSON,Date,String,Object,mode:'agc',agcCore:core,agcLoadedMission:'comanche055',selectedMission:'comanche055',appVisible:true,store,
