...
console.log('  app/core state remains explicit; renderer, clock, and display live state is owner-held behind forwarded aliases; remaining compatibility views stay audited');