...
console.log('late service boundary smoke: PASS');console.log('  late geometry/hardware/audio/visual/show layers use explicit services or compat get/replace; perceptual relay exaggeration is opt-in; no bare slot, timer, or public-API monkey-patching remains');
