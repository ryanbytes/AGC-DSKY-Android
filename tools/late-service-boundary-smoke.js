...
for(const [name,source,markers] of [
 ...
 ['stretch',stretch,["renderer.implementation('set2')","renderer.installImplementation('set2'","renderer.implementation('setReg')","renderer.installImplementation('setReg'",'renderer.segmentPattern(ch)','renderer.registerSegmentPattern(ch,value)',"display.implementation('decodeChannel10')","display.installImplementation('decodeChannel10'",'visual.withSettledWordOverride']],
...
for(const [name,source] of [['geometry',geometry],['audio refine',audioRefine],['identity',identity],['visual',visual],['stretch',stretch],['guard',guard],['perceptual',perceptual],['dream silence',dreamSilence]]){
