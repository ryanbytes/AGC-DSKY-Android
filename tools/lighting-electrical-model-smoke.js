...
const AGCDSKY={};
const context={console,Math,Number,Object,document,MutationObserver,getComputedStyle(){return{getPropertyValue(name){return properties.get(name)||''}}},AGCDSKY,window:null};context.window=context;
...
console.log('  dedicated frozen service, bootstrap compatibility getter, separate EL/incandescent branches, and V^3.4 response verified');
