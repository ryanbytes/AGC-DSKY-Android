...
assert(clock.includes('const clockState=window.AGCDSKY_APP_STATE;'),'phone-clock runtime lost shared app-state binding');
...
console.log('  shared-state clock runtime owns synthetic V35/lamp-test state while real Comanche/yaAGC V35 remains authoritative');
