...
const context={console,AGCDSKY,showControls(){calls.push(['controls'])},addEventListener(type,fn){(listeners[type]||=[]).push(fn)},window:null};context.window=context;
...
console.log('  dedicated frozen service, bootstrap getter, normal cycle excluding OFF, legacy normalization, and feed-open demo verified');
