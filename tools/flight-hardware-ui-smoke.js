...
console.log('  parser-loaded CM features, explicit dedicated presentation/mechanics/keyboard service publication, centralized normal-key/PRO input, rheostat stops, source-backed key mechanics, and three-bulb annunciators gated');
