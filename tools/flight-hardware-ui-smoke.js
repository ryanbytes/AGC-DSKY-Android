...
for(const marker of ["drawing:'2005903A'","assembly:'2003909'","module:'D8'","expression:'AND OF S1 THRU S18NC'","softwareMinimumHoldMs:null","switchId:'S19'","channel:0o32","mask:0o20000","activeLow:true","window.AGCDSKY_SERVICE_REGISTRY.publish('AGCDSKY_KEY_ELECTRICAL_SPEC', service"])req(electricalSpec,marker,'source-backed keyboard electrical spec');
