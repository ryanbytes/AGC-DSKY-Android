(() => {
  ...
  // This script is parser-loaded before the public AGCDSKY API bootstrap so
  // every extracted input layer consumes the same frozen map. PRO is
  // intentionally absent because it is a separate maintained contact on
  // channel 032.
