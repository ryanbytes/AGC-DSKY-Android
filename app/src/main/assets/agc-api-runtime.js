...
window.AGCDSKY={services:apiServices,lifecycle:apiLifecycle,agcChannel:apiDisplay.onChannel,getCore:()=>apiCore.core,setAppVisible:apiLifecycle.setAppVisible,getMission:()=>apiState.selectedMission,enterClock:publicEnterClock,enterAgc:publicEnterAgc,appStatus:apiLifecycle.status,saveAgcState:apiSnapshot.save,clearSavedAgcState:apiSnapshot.clear,savedSnapshotInfo:apiSnapshot.savedInfo,verifySnapshotRoundTrip:apiSnapshot.verifyRoundTrip,scheduleAgcAutosave:apiSnapshot.scheduleAutosave,accurateTime:apiShell.accurateTime,accurateDate:apiShell.accurateDate,ntpStatus:()=>({...apiState.ntpStatus}),nativeNtpStatus:apiShell.updateNtpStatus,hardware:publicHardware,audioStatus:publicAudioStatus,relayShow:publicRelayShow,openDiagnostics:publicOpenDiagnostics,closeDiagnostics:publicCloseDiagnostics,openSextant:publicOpenSextant,closeSextant:publicCloseSextant,sextantStatus:publicSextantStatus,applyCmMode:publicApplyCmMode,get runtimeTransitions(){return window.AGCDSKY_RUNTIME||null},get inputRuntime(){return window.AGCDSKY_INPUT||null},get clockBehavior(){return window.AGCDSKY_CLOCK_BEHAVIOR||null},get hardwareColorMode(){return window.AGCDSKY_HARDWARE_COLOR_MODE||null},get lightingElectrical(){return window.AGCDSKY_LIGHTING_ELECTRICAL||null},get lightingRheostatStop(){return window.AGCDSKY_LIGHTING_RHEOSTAT_STOP||null},get proceedElectrical(){return window.AGCDSKY_PROCEED||null}};
