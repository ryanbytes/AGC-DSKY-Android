(() => {
  ...
  function printableDocument(checklistHtml) {
    ...
    const guidance = android
      ? 'ANDROID: use the browser menu → Share → Print, or choose Save as PDF from the Android print screen.'
      : 'Use PRINT / SAVE PDF below. Your browser print dialog can also save this checklist as PDF.';
...
<style>
  ...
  #app{display:block!important;width:min(100%,760px)!important;height:auto!important;margin:12px auto!important;padding:0!important;overflow:visible!important}
